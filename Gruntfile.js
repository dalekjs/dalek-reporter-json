...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    documantix: {
      options: {
        ...
        target: 'report/docs',
        vars: {
          title: 'DalekJS - Documentation - Reporter - JSON',
          desc: 'DalekJS - Documentation - Reporter - JSON',
          docs: true
        }
      },
      src: ['index.js']
  ...
  grunt.registerTask('archive', function () {
    ...
    grunt.util.spawn({cmd: 'git', args: ['describe', '--abbrev=0', '--tags']}, function (error, result) {
      ...
      if (grunt.file.isFile('_raw/docs/' + lastTag + '/json.html')) {
      ...
      grunt.file.copy('report/docs/json.html', '_raw/docs/' + lastTag + '/json.html');
